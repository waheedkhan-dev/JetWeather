    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            JetWeatherTheme {
                ...
                val showCityNameDialog = viewModel.showCityNameDialog.collectAsState().value
                val locationPermissionGranted = viewModel.locationPermissionGranted.collectAsStateWithLifecycle().value
