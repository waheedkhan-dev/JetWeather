...
import com.wk.weatherwise.ui.components.SearchTextField
import com.wk.weatherwise.ui.components.WeatherCard
...
fun CityWeatherScreen(
    ...
    allWeathers: List<CurrentWeatherEntity>,
            ...
            if (allWeathers.isNotEmpty()) {
                LazyColumn {
                    items(allWeathers, key = { it.id }) {
                        WeatherCard(currentWeatherEntity = it, onCardClick = { cityName->
    ...
    JetWeatherTheme {
        CityWeatherScreen(
            allWeathers = listOf(
                ...
                currentWeatherEntity.copy(id = 2),
                currentWeatherEntity.copy(id = 3)
            ), onCardClick = {})
